                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                (double.tryParse(newData.openPrice)??0).toStringAsFixed(2),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                (double.tryParse(newData.highPrice)??0).toStringAsFixed(2),
                                style: bs.copyWith(color: Colors.green),
                              ),
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                (double.tryParse(newData.lowPrice)??0).toStringAsFixed(2),
                                style: bs.copyWith(color: Colors.green),
                              ),
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                (double.tryParse(newData.closePrice)??0).toStringAsFixed(2),
                                style: bs.copyWith(color: Colors.green),
                              ),
                            ],
                          ),
